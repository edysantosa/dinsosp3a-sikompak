...
class MenuSeeder extends Seeder
{
    ...
    public function run()
    {
        $menus = [
            ...
            ['id' => '12', 'menu_title' => 'Submenu level 1', 'parent_id' => 10, 'sort_order' => 2, 'slug' => '/setting/user', 'icon' => ''],
            ['id' => '13', 'menu_title' => 'Submenu level 2', 'parent_id' => 12, 'sort_order' => 1, 'slug' => '/setting/user', 'icon' => ''],
            ['id' => '14', 'menu_title' => 'Submenu level 3', 'parent_id' => 12, 'sort_order' => 2, 'slug' => '/setting/user', 'icon' => ''],
        ];
